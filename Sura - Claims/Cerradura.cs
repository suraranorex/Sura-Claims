...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("8bf5c646-0d94-488f-8470-f2b0c1685855", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s to exist. Associated repository item: 'SuraClaims.Motor.InformacionSiniestro.lbl_ReposicionDe'", repo.SuraClaims.Motor.InformacionSiniestro.lbl_ReposicionDeInfo, new ActionTimeout(10000), new RecordItemIndex(6));
            repo.SuraClaims.Motor.InformacionSiniestro.lbl_ReposicionDeInfo.WaitForExists(10000);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SuraClaims.Motor.InformacionSiniestro.Button' at 7;7.", repo.SuraClaims.Motor.InformacionSiniestro.ButtonInfo, new RecordItemIndex(7));
            repo.SuraClaims.Motor.InformacionSiniestro.Button.Click("7;7");
            Delay.Milliseconds(0);
