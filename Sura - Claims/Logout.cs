...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("1299804c-f9f8-4e4c-b03e-8b83c4ff567d", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SuraClaims.bttn_Configuracion' at Center.", repo.SuraClaims.bttn_ConfiguracionInfo, new RecordItemIndex(0));
            repo.SuraClaims.bttn_Configuracion.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SuraClaims.bttn_CerrarSesion' at Center.", repo.SuraClaims.bttn_CerrarSesionInfo, new RecordItemIndex(1));
            repo.SuraClaims.bttn_CerrarSesion.Click();
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'SuraClaims.Login.bttn_IniciarSesion'.", repo.SuraClaims.Login.bttn_IniciarSesionInfo, new RecordItemIndex(4));
            Validate.Exists(repo.SuraClaims.Login.bttn_IniciarSesionInfo);
